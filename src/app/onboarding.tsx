...
export default function OnboardingScreen() {
  return <SafeAreaView style={styles.screen}><View style={styles.content}><Text accessibilityRole="header" style={styles.title}>Let&apos;s build your{`\n`}content system.</Text><Text style={styles.copy}>Your personalized Narrial setup starts here.</Text><NarrialButton label="Back to welcome" variant="secondary" onPress={() => router.back()} /></View></SafeAreaView>;
}
